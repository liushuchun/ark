...
func TestLog_Time(t *testing.T) {
	...
	assert.Equal(t, outStr[26:], " [INFO] github.com/qiniu/log.v1/logext_test.go:53: test\n")
...
func TestLog_Level(t *testing.T) {
	...
	Warn("test")
	outStr := out.String()
	assert.Equal(t, outStr[26:], " [WARN] github.com/qiniu/log.v1/logext_test.go:74: test\n")
